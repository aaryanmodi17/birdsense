...
Northern Pintail's Gujarat‑wide detection rate fell from 0.19 (2010) to 0.07 (2025), superficially a steep decline. At a fixed, consistently‑birded hotspot (Nal Sarovar), the all‑years series looks flat (Figure 5) — but this reading is itself a sampling artifact: the 2010–2013 seasons had only 2–6 checklists at the site, where a single sighting swings the detection rate from 0.000 to 0.500. Restricted to years with ≥20 site‑level checklists, Nal Sarovar in fact declines (winter slope −0.024/yr, p = 0.039), tracking the statewide pattern rather than contradicting it. The fixed‑hotspot control needed the same effort correction as every other metric in this study before it could be trusted.
...
At fixed hotspots, effort‑corrected waterbird abundance was largely stable (few species with significant trends) once sample size was accounted for — a conclusion we can state with confidence rather than by omission. An apparent ~82% increase in Bar‑headed Goose detection rate at Thol Lake (p ≈ 0.01) did not survive a sample‑size check: restricted to years with ≥20 checklists, the trend is not significant (+0.006/yr, p = 0.49). Combined with the Nal Sarovar result above, no species in this dataset shows a site‑level abundance trend that is both significant and robust to sample size. One positive result does stand: Dalmatian Pelican, often assumed too rare for quantitative treatment, was in fact well represented (12,444 records; confirmed in all 16 study years), overturning a common working assumption.
